...
public class AutoRun {
	...
	public Intent load() {		// load a program file and create an Intent to run it
		...
		// Go to the Editor_b to display it.
		Intent intent;
...
// TODO:	The loading should be in a background thread.
			...
			Basic.loadProgramFromString(Editor_b.DisplayText, APL);	// build program in Basic.lines
			...
			intent = new Intent(mContext, Editor_b.class);			// into Editor_b so user can see it.
		}
		return intent;
	}
