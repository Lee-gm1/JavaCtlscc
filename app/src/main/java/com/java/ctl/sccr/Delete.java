...
mAdapter = new Basic.ColoredTextAdapter(this, FL, Basic.defaultTextStyle);
	...
	private void updateList() {
		// Note: The checking for SD card present was done in the Editor_b just before calling delete
	...
	public boolean onKeyUp(int keyCode, KeyEvent event) {						// If user presses back key
		if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {	// got back to the Editor_b
